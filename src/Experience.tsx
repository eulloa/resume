  ...
  <div className="container">
    <div className="p-4">
      ...
      <div className="mb-4 text-white">
        ...
        <div className="text-background">
          <h6 className="text-blue">
            Software Development Engineer II (Aug 2020 - Feb 2021)
          </h6>
          <ul>
            <li>
          ...
          <h6 className="text-blue">
            Software Development Engineer I (Nov 2017 - Aug 2020)
          </h6>
          <ul>
            <li>
            ...
            <li>
              ...
              React components into standalone GraphQL connected React
              components
            </li>
            <li>
              Responsible for configuring and integrating tools into existing
              Jenkins automation jobs
            </li>
            <li>
              Monitor code releases and investigate production issues using
              tools like Splunk and Grafana
            </li>
          </ul>
        </div>
      </div>
      <div className="mb-4 text-white">
        ...
        <div className="text-background">
          ...
          <ul>
            <li>
              Authored and contributed to full stack web develoment projects,
              with an emphasis on front end features, browser manipulation and
              cross-browser compatibility for a variety of clients such as John
              Deere, Peak Auto and Cars.com
            </li>
            <li>
              Developed applications and websites leveraging 3rd party REST APIs
              such as YouTube's iFrame Player API and Twitter's API
            </li>
            <li>
              Led development on a project that turned a dated and previously
              unresponsive application into a 100% fully responsive mobile web
              application
            </li>
          </ul>
        </div>
      ...
      <div className="mb-4 text-white">
        ...
        <div className="text-background">
          ...
          <ul>
            <li>
              Worked closely with senior developers to contribute to in house
              API infrastructure using C# and ASP.NET Web API
            </li>
            <li>
              Researched and led initiative to choose an open-source solution
              for stress and loading testing web applications, including
